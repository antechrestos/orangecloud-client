...
import orangecloud_client.commands.main as main
from orangecloud_client.abstract_domain import JsonObject
...
class TestMain(unittest.TestCase):
    ...
    @mock.patch('orangecloud_client.commands.main.load_client')
    ...
    @mock.patch('orangecloud_client.commands.main.launch_interactive_shell')
    @mock.patch('orangecloud_client.commands.main.load_client')
